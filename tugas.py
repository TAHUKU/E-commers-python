...
print("Top 5 Produk Setelah Selection Sort (Harga Terendah):")
for product in sorted_products_by_price[:5]:
...
def insertion_sort_by_rating(arr):
    for i in range(1, len(arr)):
        key_item = arr[i]
        j = i - 1
        # Mengurutkan terbalik (Descending): rating lebih besar di depan
...
print("Top 5 Produk Setelah Insertion Sort (Rating Tertinggi):")
for product in sorted_products_by_rating[:20]:
